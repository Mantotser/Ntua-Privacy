namespace Ntua_Privacy_Solution
{
    partial class page11
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Υπάρχει η δυνατότητα για την κάθε εγγραφή του πίνακα να έρθετε σε επικοινωνία με " +
    "τον ιδιοκτήτη της ώστε να καθορίσετε το επίπεδο της προστασίας του;";
