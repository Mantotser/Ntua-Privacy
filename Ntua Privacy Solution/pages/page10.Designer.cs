namespace Ntua_Privacy_Solution
{
    partial class page10
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Τα ευαίσθητα γνωρίσματα είναι μόνο αριθμητικά και θέλετε να σας δίνεται η δυνατότ" +
    "ητα να καθορίζεται την μέγιστη πιθανότητα παραβίασης προσωπικών πληροφοριών;";
