namespace Ntua_Privacy_Solution
{
    partial class page6
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Τα επιλεγμένα ψευδο-αναγνωριστικά περιλαμβάνουν ταυτόχρονα και ευαίσθητες πληροφο" +
    "ρίες;";
            ...
            this.groupBox1.Location = new System.Drawing.Point(78, 55);
