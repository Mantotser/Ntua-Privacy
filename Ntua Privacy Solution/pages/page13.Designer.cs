namespace Ntua_Privacy_Solution
{
    partial class page13
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Θέλετε καθολικά να μπορείτε να προσδιορίσετε το μέγεθος των κλάσεων ισοδυναμίας κ" +
    "αι την πιθανότητα παραβίασης ευαίσθητων πληροφοριών;";
